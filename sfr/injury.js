...
var injuryWidget = function (e, callback) {
  ...
  Ext.create('Ext.data.Store', {
    ...
    proxy: {
      ...
      method: 'get',
      cors: true,
      url: 'https://stratum.registercentrum.se/api/metadata/domainvalues/domain/5545?apikey=J6b-GSKrkfk=',
      reader: {
        type: 'json',
        rootProperty: 'data'
      }
        ...
        listeners: {
          itemclick: function (el, record) {
            if (this.hasCls('hiddenview')) {
              ...
              Ext.Ajax.request({
                url: 'https://stratum.registercentrum.se/api/metadata/domainvalues/domain/' + record.data.Domain.DomainID + '?apikey=J6b-GSKrkfk=',
