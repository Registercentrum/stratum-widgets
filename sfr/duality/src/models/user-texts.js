...
export const CONTINUE_WITH_SCREENING_QUESTION = `Denna patient uppfyller inklusionkriterierna för ${STUDY_TITLE} med randomisering mellan STANDARDCUP och DUBBELCUP vid ZZZZZ frakturer. Vill du screena patienten nu?`;
