<div id="ProfileContainer" style="min-height: 180px"></div>
<style type="text/css">
.WidgetFormItem { margin-bottom: 20px; }
.WidgetListItem li { font-size: 16px; }
.WidgetFormItem input { font-size: 16px; border: none; border-left: 1px solid #ddd; border-right: 1px solid #ccc; background-color: transparent !important; }
.WidgetFormItem .x-form-text { background-image: url('ExtJS/resources/themes/images/gray/form/text-bg.gif'); !important; }
.WidgetFormItem .x-tip-header-body { padding: 0; }
.WidgetAccordion .x-accordion-hd { border: none; margin: 2px; }
.WidgetAccordion .x-toolbar-footer { padding-bottom: 10px; }
.WidgetAccordion .x-panel-header-text { font-size: 16px; }
.TemplateTable { width: 100%; }
.TemplateTable th { padding: 10px 0px 0px 0px; color: #666; }
.TemplateTable td {  }
</style>
