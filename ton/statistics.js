...
var TonsillWidget = function () {
	...
	var _container = Stratum.containers && Stratum.containers['TON/Statistics'] || 'sw-tonstatistics';
	...
	var createChoicesPanel = function () {
		...
		Ext.util.CSS.createStyleSheet(
			...
			+ '} '
			// + '	.ton-choice .x-form-trigger-wrap {'
			// + '		border: solid 1px #359aa3;'
			// + '	}'
			+ '.nav-back-button {'
			+ '		margin: 0;'
			+ ' 	height: 24px;'
						...
						items: [
							{
								...
								legend: {
									docked: 'top',
									tpl: ['<div style="width: 180px;" class="x-legend-container">' +
		...
		var updateIndicatorData = function (chart, indicatorId, unitCode, unitName) {
			...
			Ext.Ajax.request({
				...
				success: function (response, opts) {
					...
					if (indicatorId != 1) {
						chart.legend.update(
							'<div style="width: 180px;" class="x-legend-container">' +
							'<div  class="x-legend-item">' +
				...
				items: [{
					...
					listeners: {
						activate: function () {
							...
							var legend = '<div style="width: 180px;" class="x-legend-container">' +
								'<div  class="x-legend-item">' +
